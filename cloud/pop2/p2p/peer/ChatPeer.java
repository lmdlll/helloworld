...
class ChatPeer
{
	...
	public void notifyFile(String ip, int port,String filePath,String fileName,byte[] bytes )
	{
		this.chatPeer.asyncNotify(ip, port, new SendNotification(filePath,fileName,bytes));
	}
}
