...
class ECommerceReader
{
	...
	{
		return (MerchandiseResponse)(RemoteReader.REMOTE().read(NodeID.DISTRIBUTED().getKey(), ClientConfig.SERVER_ADDRESS, ClientConfig.ECOMMERCE_SERVER_PORT, new MerchandiseRequest(model)));
	}
}
