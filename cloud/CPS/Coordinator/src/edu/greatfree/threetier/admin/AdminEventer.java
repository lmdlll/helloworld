...
class AdminEventer
{
	...
	{
		this.eventer.notify(AdminConfig.COORDINATOR_ADDRESS, AdminConfig.COORDINATOR_PORT, new ShutdownServerNotification());
	}
	
	public void shutdownTerminal() throws IOException, InterruptedException
	{
		this.eventer.notify(AdminConfig.TERMINAL_ADDRESS, AdminConfig.TERMINAL_PORT, new ShutdownServerNotification());
	}
