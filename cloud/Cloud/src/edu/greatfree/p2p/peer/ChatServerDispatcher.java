...
//	private NotificationDispatcher<ChatNotification, ChatThread, ChatThreadCreator> chatNotificationDispatcher;
	...
	private NotificationDispatcher<MesgNotification, ChatThread, ChatThreadCreator> chatNotificationDispatcher;
	...
	public ChatServerDispatcher(int threadPoolSize, long threadKeepAliveTime, int schedulerPoolSize, long schedulerKeepAliveTime)
	{
		...
		this.chatNotificationDispatcher = new NotificationDispatcher.NotificationDispatcherBuilder<MesgNotification, ChatThread, ChatThreadCreator>()
				.poolSize(ServerConfig.NOTIFICATION_DISPATCHER_POOL_SIZE)
	...
	public void process(OutMessageStream<ServerMessage> message)
	{
		...
		{	
			...
			case ChatMessageType.PEER_CHAT_NOTIFICATION:
				...
				this.chatNotificationDispatcher.enqueue((MesgNotification)message.getMessage());
				break;
		}
	}
}
