...
public class BQGame {
    public static void main(String[] args) {
        ...
        System.out.println(calPoints2(data));
    }

    //8ms  使用栈进行操作，思路是对的，但是频繁的出栈入栈耗时耗空间
        ...
        for(int i=0; i<ops.length; i++){
            switch (ops[i]){
                case "C":
                    ...
                    break;
                case "D":
                    int value = Integer.parseInt(stack.peek())*2;
